    ...
    module Responses
      ...
      def self.included(base)
        base.made_resourceful do
          ...
          response_for(:edit, :new) do |format|
            format.html { render :template => "#{instance_variable_name.tableize}/form" }
            format.js
          end
          ...
          response_for(:create_fails) do |format|
            format.html do
              ...
              render :template => "#{instance_variable_name.tableize}/form", :status => 422
            end
            format.js
          end
