...
describe User do
  ...
  it "should have many attendances to shows" do
    users(:quentin).should have_many(:attendances)
    users(:quentin).should have_many(:shows)
  end
  
  it "should have many setlists" do
    users(:quentin).should have_many(:setlists)
  end
